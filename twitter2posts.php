...
<form method="post" action="options.php" class="niceform">
    ...
    <?php //do_settings( 'baw-settings-group' ); ?>
     ...
     <tr valign="top">
           <th scope="row">Tweets Category<br /> <small>All imported Tweets will be add to this category</strong></small></th>
   ...
   <p class="advice"><img src="<?php echo plugins_url('images/clock.png', __FILE__) ?>" /> Please <strong>DONT FORGET</strong> to <a href="options-general.php"> set your local Timezone</a> otherwise your imported tweets will not have correct time.</p>
  
   <p class="advice"><img src="<?php echo plugins_url('images/archive.png', __FILE__) ?>" /><strong>ADVICE</strong> If you trashed some Tweets from Posts, tweets will not be imported again, coz sometimes we dont want show all tweets to our visitors. For import original trashed Tweets from Twitter please empty trash or restore trashed Tweets.</p>
